        ...
        <div class=" flex flex-row justify-between  font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">
            <ul class="text-md">
                <li
                    ...
                    :class="{'border-blue-700': index === tabActive }"
                    >
                    {{ city.name }}
                </li>
            </ul>
            ...
            <button @click.prevent="refresh"
                    class="relative text-sm text-blue-600 mr-5">
...
export default {
    ...
    emits: ['cityInfo', 'refresh'],

    setup(props, { emit }) {
        const cityFromSearch = ref(props.cityFromSearch)
        const tabActive = ref();
